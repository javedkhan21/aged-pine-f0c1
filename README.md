...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/aged-pine-f0c1#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/aged-pine-f0c1
```

A live public deployment of this template is available at [https://aged-pine-f0c1.templates.workers.dev](https://aged-pine-f0c1.templates.workers.dev)
